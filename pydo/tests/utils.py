...
def create_tasks_for_various_users(status: List[str] = []) -> List[str]:
    ...
    tasks_data = [
        ...
        {  # 0
            ...
            + timedelta(days=3, hours=6, minutes=30),  # Jan 4, 2025, 14:30 UTC
            'status': 'pending',
        },
        {  # 1
            'user_uuid': first_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=1, hours=2, minutes=15),  # Jan 2, 2025, 10:15 UTC
            'status': 'in_progress',
        },
        {  # 2
            'user_uuid': first_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=7, hours=12),  # Jan 8, 2025, 20:00 UTC
            'status': 'pending',
        },
        {  # 3
            'user_uuid': first_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=5, hours=9, minutes=45),  # Jan 6, 2025, 17:45 UTC
            'status': 'in_progress',
        },
        {  # 4
            'user_uuid': first_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=2, hours=1, minutes=30),  # Jan 3, 2025, 9:30 UTC
            'status': 'completed',
        },
        # Second user's tasks
        {  # 5
            ...
            'due_date': reference_date
            + timedelta(days=4, hours=3, minutes=20),  # Jan 5, 2025, 11:20 UTC
            'status': 'pending',
        },
        {  # 6
            'user_uuid': second_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=1, hours=5),  # Jan 2, 2025, 13:00 UTC
            'status': 'completed',
        },
        {  # 7
            'user_uuid': second_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=2, hours=10, minutes=15),  # Jan 3, 2025, 18:15 UTC
            'status': 'in_progress',
        },
        {  # 8
            'user_uuid': second_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(hours=18, minutes=30),  # Jan 2, 2025, 2:30 UTC
            'status': 'pending',
        },
        {  # 9
            'user_uuid': second_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=10, hours=7, minutes=45),  # Jan 11, 2025, 15:45 UTC
            'status': 'in_progress',
        },
        # Third user's tasks
        {  # 10
            ...
            'due_date': reference_date
            + timedelta(days=3, hours=4, minutes=10),  # Jan 4, 2025, 12:10 UTC
            'status': 'pending',
        },
        {  # 11
            'user_uuid': third_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=14, hours=11, minutes=30),  # Jan 15, 2025, 19:30 UTC
            'status': 'in_progress',
        },
        {  # 12
            'user_uuid': third_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=5, hours=2, minutes=20),  # Jan 6, 2025, 10:20 UTC
            'status': 'completed',
        },
        {  # 13
            'user_uuid': third_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=2, hours=8, minutes=45),  # Jan 3, 2025, 16:45 UTC
            'status': 'pending',
        },
        {  # 14
            'user_uuid': third_user.uuid,
            ...
            'due_date': reference_date
            + timedelta(days=1, hours=1, minutes=15),  # Jan 2, 2025, 9:15 UTC
            'status': 'in_progress',
        },
    ]
